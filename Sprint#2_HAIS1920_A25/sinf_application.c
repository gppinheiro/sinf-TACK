...
int main() {
	...
	pthread_t thread_config_file,thread_rules_file,thread_sensors1,thread_sensors2,thread_sensors3,thread_true_sensors_values,thread_sensor,thread_check,thread_actuator,thread_RGB;
